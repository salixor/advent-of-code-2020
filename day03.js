...
const countNumberOfTress = path => path.filter(c => c === TREE).length
...
console.log(countNumberOfTress(pathStep1))
...
console.log(prodValues(pathsStep2.map(countNumberOfTress)))
